...
### profiles
Retorna vários perfis de acordo com os IDs informados

**Parâmetros:**

| Nome | Tipo  | Descrição |
| ---- | :---: | ------------|
| `ids` | _String_ | Lista de IDs separados por vírgula. Máximo:  50 IDs |
...
**Exemplo:** [` api.csdb.app/v1/profiles?ids=5450607,6401907,5580760 `](https://api.csdb.app/v1/profiles?ids=5450607,6401907,5580760)<br>
...
### works
Retorna várias obras de acordo com os IDs informados
...
**Exemplo:** [` api.csdb.app/v1/works?ids=8063427,8947355,3651970 `](https://api.csdb.app/v1/works?ids=8063427,8947355,3651970)<br>
...
### tracks
Retorna várias músicas (gravações) de acordo com os IDs informados
...
**Exemplo:** [` api.csdb.app/v1/tracks?ids=3165776,9226281,4055834 `](https://api.csdb.app/v1/tracks?ids=3165776,9226281,4055834)<br>
...
Retorna vários perfis com base no ID do respectivo serviço externo
...
**Exemplo:** [` api.csdb.app/v1/spotify/profiles?ids=2aKyKSggb31Kw9s9i3iXoo,4fdCGYM7dtJLa3LvR1ccto,6iAY2AyUZLSX3PWLIAfFZY `](https://api.csdb.app/v1/spotify/profiles?ids=2aKyKSggb31Kw9s9i3iXoo,4fdCGYM7dtJLa3LvR1ccto,6iAY2AyUZLSX3PWLIAfFZY)<br>
...
Retorna várias músicas com base no ID do respectivo serviço externo
...
**Exemplo:** [` api.csdb.app/v1/spotify/tracks?ids=1uoA57FMhP9QjZxIJZVEWo,4VvsTSxSSAu8IRBpt3iDMR,1V3HlCCSvHmKqvGSNuSL1e `](https://api.csdb.app/v1/spotify/tracks?ids=1uoA57FMhP9QjZxIJZVEWo,4VvsTSxSSAu8IRBpt3iDMR,1V3HlCCSvHmKqvGSNuSL1e)<br>
...
| `duration` | _Number_ | Duração da música (em segundos). |
